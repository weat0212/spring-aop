...
public class InventoryAspect {
    ...
    @Before(value = "@annotation(com.example.aop.annotation.InventoryOperation)")
    public void getInventoryOperationInfo(JoinPoint joinPoint) {
        ...
        InventoryOperation accountOperation = method.getAnnotation(InventoryOperation.class);
